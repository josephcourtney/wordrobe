...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param("nowhere", {("nowhere",)}, {}, id="lexicalized-no-where"),
        pytest.param("somewhere", {("somewhere",)}, {}, id="lexicalized-some-where"),
        pytest.param("already", {("already",)}, {}, id="lexicalized-all-ready"),
        pytest.param("together", {("together",)}, {}, id="lexicalized-to-get-her"),
        pytest.param("therefore", {("therefore",)}, {}, id="lexicalized-there-for"),
